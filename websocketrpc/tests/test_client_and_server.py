...
class TestRpc(AsyncHTTPTestCase):
    ...
    def test_websocket_callbacks(self):
        ...
        client.call('foo', on_reply=client.on_fail_reply, on_error=client.on_error_good)
        self.assertEqual(OK, self.wait())

        client.call('reverse', args=['abcd'], on_reply=client.on_reverse_reply, on_error=client.on_error_fail)
        self.assertEqual(OK, self.wait())

        client.call('test_datatypes', on_reply=client.on_test_datatypes_reply, on_error=client.on_error_fail)
        self.assertEqual(OK, self.wait())

        client.call('reply_n_times', args=[3], on_reply=client.on_reply_n_times, on_error=client.on_error_fail)
        self.assertEqual(OK, self.wait())
